  ...
  return (
    <div className="flex justify-center mx-[5vw] mt-16">
      <div className="w-full max-w-[1100px]">
        <h1 className="text-4xl text-center">Publicaciones y Más</h1>
        <p className="mt-4 mb-10 text-gray-400 text-lg text-center">{`Publicaciones académicas y otros proyectos destacados`}</p>
