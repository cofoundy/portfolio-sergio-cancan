      ...
      >
        <div className="w-full max-w-[600px] text-center">
          <p className="text-lg mb-8 text-gray-400">
            ...
            colaboraciones en AI/ML, o proyectos de robótica e investigación.
          </p>

          <a
            href="mailto:sergiocancane@gmail.com"
            className="inline-flex items-center gap-3 px-8 py-4 bg-[#38bdf8] hover:bg-[#7dd3fc] text-dark rounded-lg transition duration-300 mb-12 text-lg font-medium"
          >
            <svg
              width="24"
              height="24"
          ...
          <div className="border-t border-gray-700 pt-8">
            <h2 className="text-xl mb-6">Encuéntrame en</h2>
